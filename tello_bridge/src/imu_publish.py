...
class ImuNode:
    def __init__(self):
        ...
        self.seq = 0
        self.drone_data_sub = rospy.Subscriber("tello_data", Tello_data, self.drone_data_cb, queue_size=1)
    ...
    def drone_data_cb(self, msg):
        ...
        imu_msg.linear_acceleration = geometry_msgs.msg.Vector3(msg.acc_x*g, -msg.acc_y*g, -msg.acc_z*g)
